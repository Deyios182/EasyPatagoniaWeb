  ...
  return (
    <>
      <SEO
        ...
        description={business.info?.descripcion || `Descubre ${business.nombre} en Aysén, Patagonia Chilena.`}
        image={business.media?.logo_url}
        keywords={[business.categoria, business.locality_name || 'aysén', 'patagonia', 'chile']}
        type="article"
      />
